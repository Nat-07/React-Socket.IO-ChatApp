                    ...
                    if (joined && name !== myName) {
                        ...
                        if (numMyMessages === localCount) {
                            ...
                            return (
                                ...
                                >
                                    <div className="pt-1 ml-32 bg-blue-300 rounded-lg shadow-md dark:bg-blue-500">
                                        <p className="px-2 -mb-3.5 font-sans text-sm dark:text-white">
                                            {messageText}
                                        </p>
                        ...
                        return (
                            <div
                                ...
                                key={index}
                            >
                                <div className="pt-0.5 pl-2 pr-1.5 mr-32 font-sans bg-gray-200 rounded-tl-lg rounded-bl-lg rounded-tr-xl rounded-br-xl shadow-sm dark:shadow-lg dark:bg-darkMessage opacity-90">
                                    <p
                                        className={
                                    ...
                                    <p className="-mt-0.5 text-sm leading-tight dark:text-white">
                                        {messageText}
                                    </p>
                                    <p className="flex justify-end mr-1 -mb-4 opacity-90 text-2xs dark:text-white">
                                        {currentTime}
                                    </p>

                                    <p className="-mb-2 -ml-2 font-bold text-gray-200 rounded-xl dark:text-darkMessage opacity-90">
                                        &gt;
                                    </p>
                                </div>
                            </div>
